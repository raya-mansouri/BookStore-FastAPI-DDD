...
Revision ID: 3d718c3e010d
Revises: 0b1d01d34a7b
Create Date: 2025-02-09 17:03:44.738837
...
revision: str = '3d718c3e010d'
down_revision: Union[str, None] = '0b1d01d34a7b'
...
def upgrade() -> None:
    ...
    sa.Column('bank_account_number', sa.String(length=16), nullable=False),
